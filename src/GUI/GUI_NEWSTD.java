 ...
 * @author HDTC
 */
public class GUI_NEWSTD extends javax.swing.JFrame {

    /**
     * Creates new form GUI_NEWSTD
     */
    public GUI_NEWSTD() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TẠO HỌC SINH MỚI");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_NEWSTD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_NEWSTD().setVisible(true);
            }
        });
    }
